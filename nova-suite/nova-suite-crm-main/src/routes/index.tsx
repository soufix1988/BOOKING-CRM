    ...
    <header className="sticky top-0 z-50 backdrop-blur-xl bg-background/70 border-b border-border/60">
      <nav className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <a href="/app/dashboard" className="hidden sm:block text-sm text-muted-foreground hover:text-foreground">Log in</a>
          <a href="/app/dashboard" className="px-4 py-2 rounded-full bg-gradient-button text-primary-foreground text-sm font-medium shadow-glow hover:opacity-90 transition">
            Start free
          </a>
        </div>
      </nav>
    ...
    <section className="relative bg-hero">
      ...
      <div className="relative max-w-7xl mx-auto px-6 pt-20 pb-24 text-center">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4 animate-fade-up" style={{ animationDelay: "0.2s" }}>
          <a href="/app/dashboard" className="group inline-flex items-center gap-2 px-6 py-3.5 rounded-full bg-gradient-button text-primary-foreground font-medium shadow-glow hover:scale-[1.02] transition">
            Start free trial
      ...
      <div className="grid md:grid-cols-3 gap-5 max-w-5xl mx-auto">
        {plans.map((pl) => (
          <div key={pl.n} className={`relative rounded-3xl p-8 border ${pl.featured ? "border-transparent bg-gradient-to-br from-brand-violet to-brand-indigo text-white shadow-glow scale-[1.02]" : "border-border bg-card"}`}>
            ...
            <a href="/app/dashboard" className={`mt-8 block text-center px-5 py-3 rounded-full font-medium transition ${pl.featured ? "bg-white text-brand-violet hover:bg-white/90" : "bg-gradient-button text-primary-foreground hover:opacity-90"}`}>
              {pl.cta}
            </a>
          </div>
        ))}
      ...
      <div className="relative rounded-[2.5rem] overflow-hidden p-12 md:p-20 text-center bg-gradient-to-br from-brand-indigo via-brand-violet to-brand-pink shadow-glow">
        ...
        <div className="relative">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <a href="/app/dashboard" className="px-6 py-3.5 rounded-full bg-white text-brand-violet font-medium hover:bg-white/90 transition inline-flex items-center gap-2">
