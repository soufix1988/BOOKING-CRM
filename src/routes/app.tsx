...
import { getSession, logout, getUserDisplayName, getUserInitials } from "../lib/auth";
      ...
      >
        ...
        <div className="p-3 border-t border-border space-y-1">
          ...
          <div className="flex items-center gap-3 p-2 mt-2 rounded-xl">
            <div className="size-9 rounded-full bg-gradient-to-br from-brand-violet to-brand-pink grid place-items-center text-white text-sm font-bold flex-shrink-0">
              {initials}
            </div>
